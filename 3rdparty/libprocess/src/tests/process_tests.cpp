...
protected:
  void SetUp() override
  {
    ...
    // NOTE: Because of the differences between Windows and POSIX shells when
    // interpreting quotes, we use the second form of `subprocess` to call call
    // `test-linkee` directly with a set of arguments, rather than through the
    // shell.
